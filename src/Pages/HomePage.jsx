  ...
  return (
    <main className="">
      <div className="flex justify-center items-center">
        <div className="flex flex-col items-center justify-center bg-slate-100 p-10 lg:w-fit w-full h-screen shadow-md rounded-lg">
          <div>
            <h1
          ...
          <motion.div
            ...
            style={{
              backgroundColor: targetColor?.color_code || "transparent",
            }}
          ></motion.div>
